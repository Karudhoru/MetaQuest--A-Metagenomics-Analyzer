...
# Import streamlined reporting and visualization
from .reporting import (
    generate_taxonomic_report, 
    generate_pathogen_report, 
    generate_functional_report,
    generate_pathogen_summary_report  # THE ONLY pathogen function for FASTQ
)
...
try:
    from .pathogen_predictor import run_ml_pathogen_prediction
...
def analyze_fastq(reads, output_dir):
    ...
    try:
        ...
        if bracken_report and Path(bracken_report).exists():
            try:
                from .reporting import PathogenReporter
