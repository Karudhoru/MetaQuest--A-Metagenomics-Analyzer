...
MODEL_ARTIFACTS_DIR = Path("./metaquest_v3/metagenomics/model_artifacts")

# ML MODEL CONFIGURATION
ML_CONFIG = {
    'enable_ml_prediction': True,
    'confidence_threshold': 0.7,    # Threshold for high-confidence predictions
    'batch_size': 100,              # Process sequences in batches
    'feature_cache': True,          # Cache feature extraction results
}
