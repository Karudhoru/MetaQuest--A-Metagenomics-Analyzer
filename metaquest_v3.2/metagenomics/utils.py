...
def check_model_artifacts():
    ...
    expected_models = {
        ...
        'all_feature_names': 'Feature names for pathogen prediction',
...
def check_dependencies():
    ...
    if not models_ready:
        if ML_CONFIG.get('fallback_to_heuristic', True):
            warnings.append("ML models missing - using heuristic fallback (reduced accuracy)")
        else:
            warnings.append("ML models missing - ML analysis will fail")
